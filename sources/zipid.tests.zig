...
test "integral upper bound" {
    var pid: ziPID = .{ .integral = 1.0, .integralMax = 1.0 };
    _ = pid.advance(1.0, 1);
...
test "integral lower bound" {
    var pid: ziPID = .{ .integral = 1.0, .integralMin = -1.0 };
